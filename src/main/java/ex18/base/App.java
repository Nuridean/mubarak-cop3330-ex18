...
public class App {
    public static void main(String[] args){
        ...
        if(userInput.equals("C")|| userInput.equals("c")){
            String firstOutput = "Your choice: C\n Please enter the temperature in Fahrenheit:\n";
            System.out.print(firstOutput);
            String userTemp = in.nextLine();
            double ftoc = Double.parseDouble(userTemp);
            double convertedToC = ( ( ftoc-32 ) * (5 / 9 ) );
            System.out.print("The temperature in Celsius is " + convertedToC + "." );

        }
        if(userInput.equals("F")|| userInput.equals("f")){
            String firstOutput = "Your choice: F\n Please enter the temperature in Celsius:\n";
            System.out.print(firstOutput);
            String userTemp = in.nextLine();
            double ctof = Double.parseDouble(userTemp);
            double convertedToF = ( ( ctof * 9 ) / 5 ) + 32;
            System.out.print("The temperature in Fahrenheit is " + convertedToF + "." );
